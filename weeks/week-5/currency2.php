...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
    <fieldset>
        ...
        <ul>
            <li><input type="radio" name="currency" value=".017">Rubles</li>
            <li><input type="radio" name="currency" value=".76">Canadian Dollars</li>
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($_POST['bank'] == NULL) {
        echo '<pclass = "error">Please choose a banking institution.</p>';
    }
        ...
        <div class="box">
        <h2>Hello '.$name.'</h2>
        <p>You now have <b>'.floor($dollars).' USD</b>. 
